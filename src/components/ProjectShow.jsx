...
const ProjectShow = () => {
    return (
        <div className='font-[family-name:var(--font-geist-sans)] text-center mt-40 mx-auto max-w-screen-md'>
            {/* fist dive */}
           <div>
            <h1 className='font-bold text-4xl md:text-3xl  mb-8 p-4 bg-gradient-to-r from-emerald-400 to-emerald-600 text-white rounded-md shadow-lg animate-fadeInUp'>Project Showcase</h1>
